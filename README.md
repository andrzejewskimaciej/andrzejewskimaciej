...
* [LLM Toxicity Classifier](https://github.com/andrzejewskimaciej/LLM_toxicity_classifier) - an automated tool designed to detect and categorize harmful online content by analyzing context and nuances. Offers dual-architecture approach utilizing Gemini 3.0 Flash for fast, high-precision cloud analysis or a Toxic-BERT accompanied by Llama 3.2 for private, local processing. Built using Python, FastAPI, Streamlit, and Docker.

* [ML Projects](https://github.com/andrzejewskimaciej/ML_Projects/tree/main) - Machine Learning projects including:
  * classification model with a business goal to detect fraudulent transactions in e-commerce;
  * loan customers clustering for advertising purposes;
  * interpretable models for credit risk scoring;
